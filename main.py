...
# Labels
Label(master, text="McLander Financial Treasury Solutions", font=('Calibri', 14)).grid(row=0,sticky=N,pady=10)
Label(master, text="Hassle-free monetary solutions.", font=('Calibri',12)).grid(row=1,sticky=N)
